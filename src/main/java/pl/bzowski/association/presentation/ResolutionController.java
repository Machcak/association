...
import pl.bzowski.association.business.boundary.ResolutionFacade;
...
public class ResolutionController implements Serializable {
    ...
    public Resolution prepareCreate() {
        selected = new Resolution();
        initializeEmbeddableKey();
        return selected;
    }

    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("ResolutionCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("ResolutionUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("ResolutionDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Resolution getResolution(java.lang.Long id) {
        return getFacade().find(id);
    }

    public List<Resolution> getItemsAvailableSelectMany() {
        return getFacade().findAll();
    }

    public List<Resolution> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
    ...
    public static class ResolutionControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Resolution) {
                ...
                Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), Resolution.class.getName()});
                return null;
            }
        }
